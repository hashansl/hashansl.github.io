...
{% include figure.liquid loading="eager" path="assets/img/blog/linear-algebra-1/CoordinateSystemTickMarks.svg" class="img-fluid rounded z-depth-1" alt="Coordinate system with tick marks" caption="Coordinate system" %}
...
{% include figure.liquid loading="eager" path="assets/img/blog/linear-algebra-1/UnitVectors.svg" class="img-fluid rounded z-depth-1" alt="Unit vectors" caption="Unit vectors" %}
...
{% include figure.liquid loading="eager" path="assets/img/blog/linear-algebra-1/VectorCoordinatesAsScalarsOfUnitVectors.svg" class="img-fluid rounded z-depth-1" alt="A vector as scaled unit vectors" caption="A vector" %}
...
{% include figure.liquid loading="eager" path="assets/img/blog/linear-algebra-1/LinearCombinationWithDescription.svg" class="img-fluid rounded z-depth-1" alt="Linear combination with description" caption="Linearly combination span" %}
...
{% include figure.liquid loading="eager" path="assets/img/blog/linear-algebra-1/SpanOfLinearCombination.svg" class="img-fluid rounded z-depth-1" alt="Span of linear combination" caption="Linearly combination span" %}
...
{% include figure.liquid loading="eager" path="assets/img/blog/linear-algebra-1/point_space.png" class="img-fluid rounded z-depth-1" alt="Vectors as points in space" caption="Point space" %}
...
{% include figure.liquid loading="eager" path="assets/img/blog/linear-algebra-1/LinearlyDependent.svg" class="img-fluid rounded z-depth-1" alt="Linearly dependent vectors in 2D" caption="Linearly dependent 2D" %}

{% include figure.liquid loading="eager" path="assets/img/blog/linear-algebra-1/LinearlyDependent3d.svg" class="img-fluid rounded z-depth-1" alt="Linearly dependent vectors in 3D" caption="Linearly dependent 3D" %}
