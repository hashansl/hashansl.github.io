...
description: "Published Research (BMC Public Health 2026) <br> Kalman Filtering, Spatiotemporal Modeling, Geospatial Analysis"
...
{% include apple/hero.liquid
    eyebrow="Research · Published in BMC Public Health · Associated with Oak Ridge National Laboratory & University of Tennessee, USA"
...
<div class="apple-overview">
  <p>
    <strong>Authors:</strong> Andrew Deas (lead author), <a>Adam Spannaus</a>, <strong>Hashan Fernando</strong>, Heidi A. Hanson, Anuj J. Kapadia, Jodie Trafton, Vasileios Maroulas
  </p>
  <p>
