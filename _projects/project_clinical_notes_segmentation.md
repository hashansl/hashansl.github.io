...
{% include apple/hero.liquid
    eyebrow="Data Engineering (COSC 526) · University of Tennessee, Knoxville · USA"
...
<div class="apple-overview">
  ...
  <p>
    ...
    <a href="/assets/pdf/project_clinical_notes_segmentation/Abstract_Hashan.pdf" target="_blank">Abstract</a> ·
